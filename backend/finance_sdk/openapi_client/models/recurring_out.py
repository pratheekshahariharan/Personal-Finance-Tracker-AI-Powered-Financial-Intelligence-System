...
class RecurringOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "amount", "transaction_type", "category", "frequency", "next_due_date"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if next_due_date (nullable) is None
        # and model_fields_set contains the field
        if self.next_due_date is None and "next_due_date" in self.model_fields_set:
            _dict['next_due_date'] = None
