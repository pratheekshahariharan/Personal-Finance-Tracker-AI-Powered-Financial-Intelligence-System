...
class TransactionOut(BaseModel):
    ...
    category: StrictStr
    auto_tagged: StrictBool
    timestamp: datetime
    note: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "amount", "description", "transaction_type", "category", "auto_tagged", "timestamp", "note"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auto_tagged": obj.get("auto_tagged"),
