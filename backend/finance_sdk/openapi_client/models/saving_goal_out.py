...
class SavingGoalOut(BaseModel):
    ...
    id: StrictInt
    name: StrictStr
    target_amount: Union[StrictFloat, StrictInt]
    current_amount: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["id", "name", "target_amount", "current_amount"]
